...
public class UserController {
    ...
    public BaseResponse<UserStatisticsVO> getUserStatistics(HttpServletRequest request) {
        User user = userService.getLoginUser(request);
        UserStatisticsVO statisticsVO = userService.getUserStatistics(user.getId());
    ...
    @PostMapping("/update")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> updateUser(@RequestBody UserAddRequest userUpdateRequest,
