...
import type { BaseResponse_UserStatisticsVO_ } from '../models/BaseResponse_UserStatisticsVO_';
...
id?: number,
    ...
    /**
     * getUserStatistics
     * @returns BaseResponse_UserStatisticsVO_ OK
     * @throws ApiError
     */
    public static getUserStatisticsUsingGet(): CancelablePromise<BaseResponse_UserStatisticsVO_> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/user/get/statistics',
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
                404: `Not Found`,
